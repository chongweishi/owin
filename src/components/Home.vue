...
<template>
  ...
  >
    ...
    <div class="container absolute z-1">
      ...
      >
        <h1
          class="xl:text-7xl lg:text-4xl md:text-2xl text-2xl font-semibold leading-1.2"
          data-aos="fade-down"
        >
